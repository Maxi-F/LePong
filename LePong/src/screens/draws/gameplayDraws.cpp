...
void drawField() {
    ...
    const float MID_FIELD_HEIGHT = 5.0f;
    ...
    DrawCylinder(CENTER, MID_FIELD_CIRCLE_RADIUS, MID_FIELD_CIRCLE_RADIUS, MID_FIELD_HEIGHT, MID_FIELD_CIRCLE_RADIUS, BLACK);
    DrawCylinder(CENTER, MID_FIELD_CIRCLE_RADIUS, MID_FIELD_CIRCLE_RADIUS, MID_FIELD_HEIGHT, MID_FIELD_CIRCLE_RADIUS, FIELD_LINE_COLOR);
}
